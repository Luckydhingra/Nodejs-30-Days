...
createProduct({ name: 'Hoodie', price: 900, quantity: 10 })
createProduct({ name: 'T Shirt', price: 500, quantity: 5 })
createProduct({ name: 'Notebook', price: 200, quantity: 15 })
createProduct({ name: 'Bag', price: 800, quantity: 20 })
console.log(getAllProducts())
updateProduct('65d7452fd75061f6c4f1ca07', { name: 'Shirt', price: 200, quantity: 25 })
